...
public:
	...
	* @return void
	*/
	inline void SetDrawType(const DrawType _drawType, const size_t _id);
...
inline void SkeletalMesh::SetDrawType(const DrawType _drawType, const size_t _id)
{
	mVisualEntity->SetDrawType(_drawType, _id);
}
