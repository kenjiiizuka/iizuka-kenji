...
public:
	...
	*/
	 ...
	 * @return void
	*/
	void CalucBindPoseBoneMatrix(DirectX::SimpleMath::Matrix _parentBoneMatrix = DirectX::SimpleMath::Matrix::Identity) override;
	...
	* @return void
	*/
	void CalucAnimatedBoneMatrix(DirectX::SimpleMath::Matrix _parentBoneMatrix = DirectX::SimpleMath::Matrix::Identity) override;
