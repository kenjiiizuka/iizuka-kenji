...
public:
	...
	*/
	 ...
	 * @return void
	*/
	virtual void CalucBindPoseBoneMatrix(DirectX::SimpleMath::Matrix _parentBoneMatrix = DirectX::SimpleMath::Matrix::Identity);
	...
	* @return void
	*/
	virtual void CalucAnimatedBoneMatrix(DirectX::SimpleMath::Matrix _parentBoneMatrix = DirectX::SimpleMath::Matrix::Identity);
