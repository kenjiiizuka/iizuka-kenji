...
private:
	...
	*/
	 ...
	 * @param float& (_t1) カプセル１の線分の交点
	 * @param float& (_t2) カプセル2の線分の交点
	 * @return float 最短距離 
	*/
	float CalucSegment3DToSegment3DDistance(const PrimitiveShape::Segment3D& _segment1, const PrimitiveShape::Segment3D& _segment2, DirectX::SimpleMath::Vector3& _outputVector, float& _t1, float& _t2);
