...
　　 * @return void
　　*/
    virtual void SetTexture(UINT _slot, ID3D11ShaderResourceView* _resourceView) {};
...
　　 * @return void
　　*/
    virtual void SetSampler(UINT _slot, ID3D11SamplerState* _samplerState) {};                 // サンプラーステートセット
