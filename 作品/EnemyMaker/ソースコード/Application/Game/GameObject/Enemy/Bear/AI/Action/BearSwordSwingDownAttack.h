/**
* @file BearSwordSwingDownAttack.h
* @brief BearSwordSwingDownAttackクラスの定義
*/
...
/**
* @class BearSwordSwingDownAttack
* @brief 熊の敵の剣を振り下ろす攻撃
*/
class BearSwordSwingDownAttack : public BearAttackAction
{
public:
	/**
	* 引数ありコンストラクタ
	...
	*/
	BearSwordSwingDownAttack(std::shared_ptr<BlackBoard> _blackBoard);
