/**
* @file BearSwipingAttack.h
* @brief BearSwipingAttackクラスの定義
*/
...
/**
* @class BearSwipingAttack
* @brief 熊の敵の腕殴り攻撃
*/
class BearSwipingAttack : public BearAttackAction
{
public:
	/**
	* 引数ありコンストラクタ
	...
	*/
	BearSwipingAttack(std::shared_ptr<BlackBoard> _blackBoard);
