...
*/
class BattleManager final : public GameObject
{
public:
	/**
	* @enum BattleState
...
private:
	...
	/** リザルト演出カメラ */
	std::weak_ptr<CinematicCamera> mResultCamera;

	/** 戦闘BGM */
	std::weak_ptr<AudioComponent> mBattleBGM;
...
public:
	...
	* @return void
	*/
	void Init(const std::shared_ptr<Player> _player, const std::shared_ptr<EnemyBase> _enemy);
