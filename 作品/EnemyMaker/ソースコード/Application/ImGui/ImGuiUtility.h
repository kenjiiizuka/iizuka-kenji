...
public:
	...
	* @param std::string_view (_label)
	* @param std::vector<std::string> (_itemName)
	* @param int& (_current)
	* @return void 
	*/
	void Combo(std::string_view _label, std::vector<std::string> _itemName, int& _current);

	/**
	* @fn InputVector2
	* @brief Vector2をInputFloat2で表示できるようにラップした関数
	* @param std::string_view (_label)
	...
	*/
	...
	/**
	* @fn InputVector3
	* @brief Vector3をInputFloat3で表示できるようにラップした関数
	* @param std::string_view (_label)
	* @param DirectX::SimpleMath::Vector3& (_vector)
	* @return void
	*/
	void InputVector3(std::string_view _label, DirectX::SimpleMath::Vector3& _vector);

	/**
	* @fn InputInt
	* @brief ImGui::InputIntをラップしたクラス
	* @param std::string_view (_label)
	* @param uint16_t& (_value)
	* @return void
	*/
	void InputInt(std::string_view _label, uint16_t& _value);
	...
	* @param
	*/
	void ImGuiCurve(std::string_view _label, const DirectX::SimpleMath::Vector2 _size);
