...
bool CollisionDetector3D::DetectorCapsuleAndCapsuleOverlap(CapsuleCollisionComponent* _capsule1, CapsuleCollisionComponent* _capsule2, DirectX::SimpleMath::Vector3& _depth)
{
	...
	float lineDistance = CalucSegment3DToSegment3DDistance(segment_1, segment_2, collisionDepth);
...
float CollisionDetector3D::CalucSegment3DToSegment3DDistance(const PrimitiveShape::Segment3D& _segment1, const PrimitiveShape::Segment3D& _segment2, DirectX::SimpleMath::Vector3& _outputVector)
{
	// 線分のベクトルを求める
