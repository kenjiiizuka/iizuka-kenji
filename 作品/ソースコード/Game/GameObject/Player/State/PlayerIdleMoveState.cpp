...
void PlayerIdleMoveState::Update()
{
	...
	/*ImGui::Begin("IdleMoveState");
	ImGui::Text("StickDirection X %.2f Y %.2f Z %.2f", direction.x, direction.y, direction.z);
	ImGui::Text("StickDirectionLength %.2f", direction.Length());
	ImGui::End();*/
